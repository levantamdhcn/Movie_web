<div id="content">
  <div class="block" id="movie-recommend">
    <div class="col">
      ...
      <div class="blockbody" id="phim-bo-hay">
        <ul class="list tab phim-bo-moi w-100 mt-2">
          <?php
        ...
        <ul class="list tab phim-bo-full hide w-100 mt-2">
          <?php
  ...
  <div class="block mt-3 col" id="movie-update">
    <div class="blocktitle d-flex">
        ...
        <ul class="list-film">
          ...
          ?>
            <li data-liked="852" data-views="49,875">
              <div class="inner hover-effect"><a class="shadow" href="?mod=detail&film_id=<?php echo $r['id'] ?>" title="<?php echo $r['name'] ?>"><img src="<?php echo $r['image'] ?>" alt="Nhật Ký Trả Thù 2"></a>
                <div class="info">
  ...
  <div class="block col">
    <div class="blocktitle justify-content-between"">
      ...
      <div class="more m-0"><a href="?mod=list&type=category&id=9">Xem thêm</a> »</div>
    </div>
    <div class="blockbody" id="list-movie-update">
      <div class="tab">
