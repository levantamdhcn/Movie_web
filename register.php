...
<head>
  ...
  <style type="text/css">
    ...
    .notifyerror{
      ...
      <h3 style="font-size:30px;text-align:center;margin-bottom:0px;margin-top:40px;color: white;">Đăng ký thành viên</h3>
          ...
          <div class="container">
            <div class="row">
              <div class="col col-sm-12">
                ...
                <div class="form-group">
                  <label class="col-lg-3 control-label" style="padding-top: 4px;">Giới tính</label>
                  <div class="col-lg-7">
                ...
                <div class="col col-sm-12 text-right">
                  <button 
                    ...
                    id="button_update" 
                    name="button_update" 
                    style="margin-right: 190px; background-color: var(--main-color); border: none; padding: 9px 16px; font-weight: 500;"
                  >
                    Đăng ký
                  </button>
                </div>
